...
(11) **Generating Long and Informative Reviews with Aspect-Aware Coarse-to-Fine Decoding**
...
(29) **Token-level Dynamic Self-Attention Network for Multi-Passage Reading Comprehension**
...
(48) **Explicit Utilization of General Knowledge in Machine Reading Comprehension**
...
(67) **Counterfactual Data Augmentation for Mitigating Gender Stereotypes in Languages with Rich Morphology**
...
(86) **SP-10K: A Large-scale Evaluation Set for Selectional Preference Acquisition**
...
(117) **Distantly Supervised Named Entity Recognition using Positive-Unlabeled Learning**
, Minlong Peng, Xiaoyu Xing, Qi Zhang, Jinlan Fu and Xuanjing Huang

(118) **Dual Adversarial Neural Transfer for Low-Resource Named Entity Recognition**
, Joey Tianyi Zhou, Hao Zhang, Di Jin, Hongyuan Zhu, Meng Fang, Rick Siow Mong Goh and Kenneth Kwok

(119) **Exploiting Entity BIO Tag Embeddings and Multi-task Learning for Relation Extraction with Imbalanced Data**
...
(122) **Distilling Discrimination and Generalization Knowledge for Event Detection via Delta-Representation Learning**
...
(140) **Relation Embedding with Dihedral Group in Knowledge Graph**
...
(143) **Multi-grained Named Entity Recognition**
...
(150) **A Joint Named-Entity Recognizer for Heterogeneous Tag-sets Using a Tag Hierarchy**
...
(158) **Proactive Human-Machine Conversation with Explicit Conversation Goal**
...
(176) **Semantic Parsing with Dual Learning**
...
(194) **The PhotoBook Dataset: Building Common Ground through Visually-Grounded Dialogue**
...
(209) **Low-resource Deep Entity Resolution with Transfer and Active Learning**
...
(212) **A Cross-Domain Transferable Neural Coherence Model**
...
(226) **Boosting Entity Linking Performance by Leveraging Unlabeled Documents**
, Phong Le and Ivan Titov
...
(230) **End-to-End Sequential Metaphor Identification Inspired by Linguistic Theories**
...
(244) **Merge and Label: A novel neural network architecture for nested NER**
...
(248) **Bridging the Gap between Training and Inference for Neural Machine Translation**
...
(267) **Probing for Semantic Classes: Diagnosing the Meaning Content of Word Embeddings**
...
(304) **Multi-Task Deep Neural Networks for Natural Language Understanding**
...
(306) **Massively Multilingual Transfer for NER**
...
(321) **HellaSwag: Can a Machine Really Finish Your Sentence?**
...
(338) **The Linguistic Development of Mental Health Counselors**
...
(356) **Multimodal and Multi-view Models for Emotion Recognition**
...
(372) **Cross-Domain NER using Cross-Domain Language Modeling**
...
(374) **Fine-tuning Pre-Trained Transformer Language Models to Distantly Supervised Relation Extraction**
...
(392) **Domain Adaptation of Neural Machine Translation by Lexicon Induction**
...
(412) **Graph-based Dependency Parsing with Graph Neural Networks**
...
(431) **Mitigating Gender Bias in Natural Language Processing: Literature Review**
...
(449) **Figurative Usage Detection of Symptom Words to Improve Personal Health Mention Detection**
...
(460) **A Neural Multi-digraph Model for Chinese NER with Gazetteers**
, Ruixue Ding, Pengjun Xie, Xiaoyan Zhang, Wei Lu, Linlin Li and Luo Si

(461) **Neural Architectures for Nested NER through Linearization**
...
(468) **Numeracy-600K: Learning Numeracy for Detecting Exaggerated Information in Market Comments**
...
(473) **NNE: A Dataset for Nested Named Entity Recognition in English Newswire**
...
(486) **CNNs found to jump around more skillfully than RNNs: Compositional generalization in seq2seq convolutional networks**
...
(504) **Fine-Grained Spoiler Detection from Large-Scale Review Corpora**
...
(524) **Towards Automating Healthcare Question Answering in a Noisy Multilingual Low-Resource Setting**
...
(528) **Joint Entity Extraction and Assertion Detection for Clinical Text**
...
(543) **Towards Improving Neural Named Entity Recognition with Gazetteers**
...
(561) **Graph based Neural Networks for Event Factuality Prediction using Syntactic and Semantic Structures**
...
(579) **Generating Diverse Translations with Sentence Codes**
...
(583) **A Semi-Markov Structured Support Vector Machine Model for High-Precision Named Entity Recognition**
...
(598) **Energy and Policy Considerations for Deep Learning in NLP**
...
(618) **Learning Representations from Imperfect Time Series Data via Tensor Rank Regularization**
...
(636) **Bilingual Lexicon Induction through Unsupervised Machine Translation**
, Mikel Artetxe, Gorka Labaka and Eneko Agirre
...
(643) **BERT-based Lexical Substitution**
, Wangchunshu Zhou, Tao Ge, Ke Xu, Furu Wei and Ming Zhou

(644) **An Empirical Study of Span Representations in Argumentation Structure Parsing**
, Tatsuki Kuribayashi, Hiroki Ouchi, Naoya Inoue, Paul Reisert, Toshinori Miyoshi, Jun Suzuki and Kentaro Inui

(645) **Collocation Classification with Unsupervised Relation Vectors**
, Luis Espinosa Anke, Steven Schockaert and Leo Wanner

(646) **We need to talk about standard splits**
, Kyle Gorman and Steven Bedrick

(647) **Generating Fluent Adversarial Examples for Natural Languages**
, Huangzhao Zhang, Hao Zhou, Ning Miao and Lei Li

(648) **Modeling Semantic Relationship in Multi-turn Conversations with Hierarchical Latent Variables**
, Lei Shen, Yang Feng and Haolan Zhan

(649) **Generating Summaries with Topic Templates and Structured Convolutional Decoders**
, Laura Perez-Beltrachini, Yang Liu and Mirella Lapata

(650) **Unsupervised Rewriter for Multi-Sentence Compression**
, Yang Zhao, Xiaoyu Shen, Wei Bi and Akiko Aizawa

(651) **Model-Agnostic Meta-Learning for Relation Classification with Limited Supervision**
, Abiola Obamuyide and Andreas Vlachos

(652) **Label-Agnostic Sequence Labeling by Copying Nearest Neighbors**
, Sam Wiseman and Karl Stratos

(653) **Rationally Reappraising ATIS-based Dialogue Systems**
, Jingcheng Niu and Gerald Penn

(654) **Automatic Grammatical Error Correction for Sequence-to-sequence Text Generation: An Empirical Study**
, Tao Ge, Xingxing Zhang, Furu Wei and Ming Zhou

(655) **Coreference Resolution with Entity Equalization**
, Ben Kantor and Amir Globerson

(656) **Simultaneous Translation with Flexible Policy via Restricted Imitation Learning**
, Baigong Zheng, Renjie Zheng, Mingbo Ma and Liang Huang

(657) **Twitter Homophily: Network Based Prediction of User's Occupation**
, Jiaqi Pan, Rishabh Bhardwaj, Wei Lu, Hai Leong Chieu, Xinghao Pan and Ni Yi Puay

(658) **Exploring Numeracy in Word Embeddings**
, Aakanksha Naik, Abhilasha Ravichander, Carolyn Rose and Eduard Hovy

(659) **MC^2: Multi-perspective Convolutional Cube for Conversational Machine Reading Comprehension**
, Xuanyu Zhang

(660) **Constructing Interpretive Spatio-Temporal Features for Multi-Turn Responses Selection**
, Junyu Lu, Chenbin Zhang, Zeying Xie, Guang Ling, Tom Chao Zhou and Zenglin Xu

(661) **SYSTEM DEMONSTRATION PAPERS**
, BACK TO TOP

(662) **Sakura: Large-scale Incorrect Example Retrieval System for Learners of Japanese as a Second Language**
, Mio Arai, Tomonori Kodaira and Mamoru Komachi

(663) **SLATE: A Super-Lightweight Annotation Tool for Experts**
, Jonathan K. Kummerfeld

(664) **lingvis.io - A Linguistic Visual Analytics Framework**
...
(665) **SARAL: A Low-Resource Cross-Lingual Domain-Focused Information Retrieval System for Effective Rapid Document Triage**
...
(666) **Jiuge: A Human-Machine Cooperative Chinese Classical Poetry Generation System**
, Guo Zhipeng, Xiaoyuan Yi, Maosong Sun, Wenhao Li, Cheng Yang, Jiannan Liang, Huimin Chen, Yuhui Zhang and Ruoyu Li

(667) **Rapid Customization for Event Extraction**
, Yee Seng Chan, Joshua Fasching, Haoling Qiu and Bonan Min

(668) **A Multiscale Visualization of Attention in the Transformer Model**
, Jesse Vig

(669) **PostAc : A Visual Interactive Search, Exploration, and Analysis Platform for PhD Intensive Job Postings**
, Chenchen Xu, Inger Mewburn, Will J Grant and Hanna Suominen

(670) **An adaptable task-oriented dialog system for stand-alone embedded devices**
...
(671) **AlpacaTag: An Active Learning-based Crowd Annotation Framework for Sequence Tagging**
, Bill Yuchen Lin, Dong-Ho Lee, Frank F. Xu, Ouyu Lan and Xiang Ren

(672) **ConvLab: Multi-Domain End-to-End Dialog System Platform**
...
(673) **Demonstration of a Neural Machine Translation System with Online Learning for Translators**
...
(674) **FASTDial: Abstracting Dialogue Policies for Fast Development of Task Oriented Agents**
, Serra Sinem Tekiroglu, Bernardo Magnini and Marco Guerini

(675) **A Neural, Interactive-predictive System for Multimodal Sequence to Sequence Tasks**
, Álvaro Peris and Francisco Casacuberta

(676) **NeuralClassifier: An Open-source Neural Hierarchical Multi-label Text Classification Toolkit**
, Liqun Liu, Funan Mu, Pengyu Li, Xin Mu, Jing Tang, Xingsheng Ai, Ran Fu, Lifeng Wang and Xing Zhou

(677) **ADVISER: A Dialog System Framework for Education & Research**
...
(683) **PerspectroScope: A Window to the World of Diverse Perspectives**
, Sihao Chen, Daniel Khashabi, Chris Callison- Burch and Dan Roth

(684) **HEIDL: Learning Linguistic Expressions with Deep Learning and Human-in-the- Loop**
, Prithviraj Sen, Yunyao Li, Eser Kandogan, Yiwei Yang and Walter Lasecki

(685) **My Turn To Read: An Interleaved E-book Reading Tool for Developing and Struggling Readers**
, Nitin Madnani, Beata Beigman Klebanov, Anastassia Loukina, Binod Gyawali, John Sabatini, Patrick Lange, Michael Flor

(686) **GrapAL: Connecting the Dots in Scientific Literature**
, Christine Betts, Joanna Power and Waleed Ammar

(687) **ClaimPortal: Integrated Monitoring, Searching, Checking, and Analytics of Factual Claims on Twitter**
, Sarthak Majithia, Fatma Arslan, Sumeet Lubal, Damian Jimenez, Priyank Arora, Josue Caraballo and Chengkai Li

(688) **Texar: A Modularized, Versatile, and Extensible Toolkit for Text Generation**
...
(689) **Parallax: Visualizing and Understanding the Semantics of Embedding Spaces via Algebraic Formulae**
, Piero Molino, Yang Wang and Jiawei Zhang

(690) **Flambé: A Customizable Framework for Multistage Natural Language Processing Experiments**
, Jeremy Wohlwend, Nicholas Matthews and Ivan Itzcovich

(691) **A Modular Tool for Automatic Summarization**
, Valentin Nyzam and Aurélien Bossard

(692) **TARGER: Neural Argument Mining at Your Fingertips**
...
(693) **MoNoise: A Multi-lingual and Easy-to-use Lexical Normalization Tool**
, Rob van der Goot

(694) **Level-Up: Learning to Improve Proficiency Level of Essays**
, Wen-Bin Han, Jhih-Jie Chen, Chingyu Yang and Jason Chang

(695) **Learning to Link Grammar and Encyclopedic Information of Assist ESL Learners**
...
(696) **STUDENT RESEARCH WORKSHOP PAPERS**
, BACK TO TOP

(697) **A computational linguistic study of personal recovery in bipolar disorder**
, Glorianna Jagfeld

(698) **A Japanese Word Segmentation Proposal**
, Stalin Aguirre and Josafá Aguiar

(699) **A Strong and Robust Baseline for Text-Image Matching**
, Fangyu Liu and Rongtian Ye

(700) **Active Reading Comprehension: A dataset for learning the Question-Answer Relationship strategy**
, Diana Galvan

(701) **Analyzing and Mitigating Gender Bias in Languages with Grammatical Gender and Bilingual Word Embeddings**
, Pei Zhou, Weijia Shi, Jieyu Zhao, Kuan-Hao Huang, Muhao Chen and Kai-Wei Chang

(702) **Annotating and Analyzing Semantic Role of Elementary Units and Relations in Online Persuasive Arguments**
, Ryo Egawa, Gaku Morio and Katsuhide Fujita

(703) **ARHNet - Leveraging Community Interaction For Detection Of Religious Hate Speech In Arabic**
, Arijit Ghosh Chowdhury, Aniket Didolkar, Ramit Sawhney and Rajiv Ratn Shah

(704) **Attention and Lexicon Regularized LSTM for Aspcet-based Sentiment Analysis**
, Lingxian Bao, Patrik Lambert and Toni Badia

(705) **Attention over Heads: A Multi-Hop Attention for Neural Machine Translation**
, Shohei Iida, Ryuichiro Kimura, Hongyi Cui, Po-Hsuan Hung, Takehito Utsuro and Masaaki Nagata

(706) **Automated Cross-language Intelligibility Analysis of Parkinson's Disease Patients Using Speech Recognition Technologies**
, Nina Hosseini-Kivanani, Juan Camilo Vásquez-Correa, Manfred Stede and Elmar Nöth

(707) **Automatic Data-Driven Approaches for Evaluating the Phonemic Verbal Fluency Task with Healthy Adults**
, Hali Lindsay, Nicklas Linz and Johannes Tröger

(708) **Automatic Generation of Personalized Comment Based on User Profile**
, Wenhuan Zeng, Abulikemu Abuduweili, Lei Li and Pengcheng Yang

(709) **BREAKING! Presenting fake news corpus for automated fact checking**
, Archita Pathak and Rohini Srihari

(710) **Computational ad hominem detection**
, Pieter Delobelle, Murilo Cunha, Eric Massip Cano, Jeroen Peperkamp and Bettina Berendt

(711) **Controllable Text Simplification with Lexical Constraint Loss**
, Daiki Nishihara, Tomoyuki Kajiwara and Yuki Arase

(712) **Controlling Grammatical Error Correction Using Word Edit Rate**
...
(714) **Corpus Creation and Analysis for Named Entity Recognition in Telugu-English Code-Mixed Social Media Data**
...
(716) **Cross-domain and Cross-lingual Abusive Language Detection: a Hybrid Approach with Deep Learning and a Multilingual Lexicon**
, Endang Wahyu Pamungkas and Viviana Patti

(717) **De-Mixing Sentiment from Code-Mixed Text**
, Yash Kumar Lal, Vaibhav Kumar, Mrinal Dhar, Manish Shrivastava and Philipp Koehn

(718) **Deep Neural Models for Medical Concept Normalization in User-Generated Texts**
, Zulfat Miftahutdinov and Elena Tutubalina

(719) **Detecting Political Bias in News Articles Using Headline Attention**
, Rama Rohit Reddy Gangula, Suma Reddy Duggenpudi and Radhika Mamidi

(720) **Developing OntoSenseNet: A Verb-Centric Ontological Resource for Indian Languages and Analysing Stylometric Difference in Men and Women Writing using the Resource**
, Jyoti Jha and Navjyoti Singh

(721) **Dialogue-Act Prediction of Future Responses based on Conversation History**
, Koji Tanaka, Junya Takayama and Yuki Arase

(722) **Distributed Knowledge Based Clinical Auto-Coding System**
, Rajvir Kaur

(723) **Embedding Strategies for Specialized Domains: Application to Clinical Entity Recognition**
, Hicham El Boukkouri, Olivier Ferret, Thomas Lavergne and Pierre Zweigenbaum

(724) **English-Indonesian Neural Machine Translation for Spoken Language Domains**
, Meisyarah Dwiastuti

(725) **Enriching Neural Models with Targeted Features for Dementia Detection**
, Flavio Di Palo and Natalie Parde

(726) **Exploring the potential of Neural Networks for Extracting Adverse Drug Reactions from Biomedical Texts**
, Ilseyar Alimova and Elena Tutubalina

(727) **Fact or Factitious? Contextualized Opinion Spam Detection**
, Stefan Kennedy, Niall Walsh, Kirils Sloka, Andrew McCarren and Jennifer Foster

(728) **From Bilingual to Multilingual Neural Machine Translation by Incremental Training**
, Carlos Escolano, Marta R. Costa-jussà and José A. R. Fonollosa

(729) **From brain space to distributional space: the perilous journeys of fMRI decoding**
, Gosse Minnema and Aurélie Herbelot

(730) **Gender Stereotypes Differ between Male and Female Writings**
, Yusu Qian

(731) **Hierarchical Multi-label Classification of Text with Capsule Networks**
, Rami Aly, Steffen Remus and Chris Biemann

(732) **Imperceptible Adversarial Examples for Automatic Speech Recognition**
, Yao Qin
...
(734) **Improving Neural Entity Disambiguation with Graph Embeddings**
...
(737) **Joint Learning of Named Entity Recognition and Entity Linking**
...
(739) **Long-Distance Dependencies don't have to be Long: Simplifying through Provably (Approximately) Optimal Permutations**
, Rishi Bommasani

(740) **Māori Loanwords: A Corpus of New Zealand English Tweets**
, David Trye, Andreea Calude, Felipe Bravo-Marquez and Te Taka Keegan

(741) **Measuring the Value of Linguistics: A Case Study from St. Lawrence Island Yupik**
, Emily Chen

(742) **Multilingual model using cross-task embedding projection**
, Jin Sakuma and Naoki Yoshinaga

(743) **Multimodal Logical Inference System for Visual-Textual Entailment**
, Riko Suzuki, Hitomi Yanaka, Masashi Yoshikawa, Koji Mineshima and Daisuke Bekki

(744) **Multiple Character Embeddings for Chinese Word Segmentation**
, Jianing Zhou, Jingkang Wang and Gongshen Liu

(745) **Natural Language Generation: Recently Learned Lessons, Directions for Semantic Representation-based Approaches, and the case of Brazilian Portuguese Language**
, Marco Antonio Sobrevilla Cabezudo and Thiago Pardo

(746) **Normalizing Non-canonical Turkish Texts Using Machine Translation Approaches**
, Talha Çolakoğlu, Umut Sulubacak and Ahmet Cüneyd Tantuğ

(747) **Not All Reviews are Equal: Towards Addressing Reviewer Biases for Opinion Summarization**
, Wenyi Tay

(748) **On Dimensional Linguistic Properties of the Word Embedding Space**
, Vikas Raunak, Vaibhav Kumar, Vivek Gupta and Florian Metze

(749) **On the impressive performance of randomly weighted encoders in summarization tasks**
, Jonathan Pilault, Jaehong Park and Christopher Pal

(750) **Paraphrases as Foreign Languages in Multilingual Neural Machine Translation**
, Zhong Zhou, Matthias Sperber and Alexander Waibel

(751) **Predicting the Outcome of Deliberative Democracy: A Research Proposal**
, Conor McKillop

(752) **Public Mood Variations in Russia based on Vkontakte Content**
, Sergey Smetanin

(753) **Question Answering in the Biomedical Domain**
, Vincent Nguyen

(754) **Ranking of Potential Questions**
, Luise Schricker and Tatjana Scheffler

(755) **Reducing Gender Bias in Word-Level Language Models with A Gender-Equalizing Loss Function**
, Yusu Qian, Urwa Muaz, Ben Zhang and Jae Won Hyun

(756) **Robust to Noise Models in Natural Language Processing Tasks**
, Valentin Malykh

(757) **Scheduled Sampling for Transformers**
, Tsvetomila Mihaylova and André F. T. Martins

(758) **Sentence Level Curriculum Learning for Improved Neural Conversational Models**
, Sean Paulsen

(759) **Sentiment Analysis on Naija-Tweets**
, Taiwo Kolajo, Olawande Daramola and Ayodele Adebiyi

(760) **Sentiment Classification using Document Embeddings trained with Cosine Similarity**
, Tan Thongtan and Tanasanee Phienthrakul

(761) **STRASS: A Light and Effective Method for Extractive Summarization Based on Sentence Embeddings**
, Léo Bouscarrat, Antoine Bonnefoy, Thomas Peel and Cécile Pereira

(762) **Towards incremental learning of word embeddings using context informativeness**
, Alexandre Kabbach, Kristina Gulordava and Aurélie Herbelot

(763) **Towards Turkish Abstract Meaning Representation**
, Zahra Azin and Gülşen Eryiğit

(764) **Transfer Learning Based Free-Form Speech Command Classification for Low-Resource Languages**
, Yohan Karunanayake, Uthayasanker Thayasivam and Surangika Ranathunga

(765) **Unsupervised Learning of Discourse-Aware Text Representation for Essay Scoring**
, Farjana Sultana Mim, Naoya Inoue, Paul Reisert, Hiroki Ouchi and Kentaro Inui

(766) **Unsupervised Pretraining for Neural Machine Translation Using Elastic Weight Consolidation**
, Dušan Variš and Ondřej Bojar

(767) **Using Semantic Similarity as Reward for Reinforcement Learning in Sentence Generation**
